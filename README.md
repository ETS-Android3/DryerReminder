...
Like with projects that are proposed and developed for companies, I had made a [project proposal](https://github.com/Mmohler1/DryerReminder/blob/main/Design/Project%20Proposal/CST_451_Project_Proposal_Template.docx), [project requirements](https://github.com/Mmohler1/DryerReminder/blob/main/Design/Project%20Proposal/CST-451%20Project%20Requirements%20Template.docx), and [project designs](https://github.com/Mmohler1/DryerReminder/blob/main/Design/Project%20Proposal/CST-451%20Project%20Design%20Template.docx) before I could go ahead with the Dryer Reminder. I then took constructive criticism from my teacher, who reviewed them, and from there I could get to work. The majority of the documentation comes from these project proposals and can be found [here](https://github.com/Mmohler1/DryerReminder/tree/main/Design/Project%20Proposal). In them you can find designs like a Sitemap, which was made to showcase how users will navigate the website. A logical diagram was used to show how the application on both devices communicate with each other and what technologies were used during that process. Wireframes were set up to get an idea how the android pages would look, and more. All of these documents can be found [here](https://github.com/Mmohler1/DryerReminder/tree/main/Design), but here is a sample of a few of them.
